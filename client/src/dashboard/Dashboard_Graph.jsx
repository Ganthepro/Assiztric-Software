    ...
    return (
        <div className="main-dashboardGraph">
            ...
            <div className="slideBar">
                <button style={{left:"25%"}} ref={option[0]} onClick={() => setSlideBarMove(0)}>วัน</button>
                <button style={{left:"75%"}} ref={option[1]} onClick={() => setSlideBarMove(1)}>สัปดาห์</button>
                <div className="bar-slideBar" ref={slideBar}></div>
            </div>
            <div className="dashboardGraph">
                <p style={{top:"0",left:"0",margin:"5px",position:"absolute",color:"#E9714F"}}>อัปเตดวันนี้ 10.43 PM</p>
                แผนภูมิ
            </div>
        </div>
    );
